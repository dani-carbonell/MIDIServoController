...
// Must be before other USB declarations
USBDevice.setID(0x239A, 0x8022);
USBDevice.setManufacturerDescriptor("RXM");
USBDevice.setProductDescriptor("Damping Controller");
#endif
...
void setup() {
  ...
  // Configure USB MIDI
  TinyUSBDevice.setID(0x239A, 0x8022); //Change this to your own VID/PID
  TinyUSBDevice.setProductDescriptor("Servo Controller"); //Change this to your own product name

  usb_midi.setStringDescriptor("Servos");
  usb_midi.begin();
